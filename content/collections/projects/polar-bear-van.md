...
links:
  -
    ...
    enabled: true
    label: 'Build Thread'
    url: 'https://sportsmobileforum.com/threads/polar-bear-1.736163/'
    icon: external
  -
    type: link
    enabled: true
    label: 'Intro Post'
    url: 'https://zaskoda.com/2009/10/28/introducing-polar-bear/'
    icon: external
  -
    type: link
    enabled: true
    label: 'Video'
    url: 'https://www.youtube.com/watch?v=bVIMav0zjVU'
    icon: youtube
project_type:
  - vehicle-build
  - fabrication

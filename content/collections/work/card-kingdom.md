...
end_date: '2021-03-01'
location: 'Seattle, WA'
summary: "Five years on the engineering team of one of North America's largest Magic: The Gathering retailers, working across e-commerce, fraud prevention, and infrastructure."
achievements:
  -
    type: achievement
    enabled: true
    text: 'Implemented fraud detection that eliminated $100,000+ in annual credit card losses'
  -
    type: achievement
    enabled: true
    text: 'Brought the legacy payment codebase into PCI compliance'
  -
    type: achievement
    enabled: true
    text: 'Monitored system reliability with Splunk: log management, dashboards, alerting'
  -
    type: achievement
    enabled: true

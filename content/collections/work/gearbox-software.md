...
is_current: false
location: 'Plano, TX'
summary: 'Ran websites, online community, and internal tools at the studio behind Brothers in Arms — including one of the largest game developer forums of its era.'
achievements:
  -
    type: achievement
    enabled: true
    text: 'Grew and ran one of the largest, most active game developer forums of the era'
  -
    type: achievement
    enabled: true
    text: 'Built a custom PHP MVC framework from scratch; later led migration to CakePHP'
  -
    type: achievement
    enabled: true
    text: 'Pioneered rehabilitative moderation: only two users were ever jailed twice, none more'
tech_stack:
  - php
  - cakephp
related_projects:

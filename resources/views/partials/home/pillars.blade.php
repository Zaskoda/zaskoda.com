<section class="bg-slate py-20 px-6 md:px-12 lg:px-16">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="surface-card p-8">
            <svg class="w-8 h-8 text-circuit-500 mb-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="flex gap-4">
                ...
                <a href="/projects" class="font-ui text-sm">&rarr; Projects</a>
            </div>
        </div>
